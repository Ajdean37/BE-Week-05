...
public class Labs {
	...
	public static void main(String[] args) {
		...
		//				
		// ii. Each suit has 13 cards:  Two, Three, Four, Five, Six, Seven, Eight, Nine, Ten, Jack, Queen King & Ace
		//
		// iii. Comparing Cards:  When comparing two cards, Ace is high and Two is low. to make this easy, a Two will have a value of 2, a Three will have a value of 3, ... and an Ace will have a  value of 14.
		...
		//
		//	Methods:  
		//	a. describe() to describe the deck to the Console -- print out all of the cards in the deck.
		//
		...
		// 5. Create Game Board:
		// Create and test a method that takes an int as a parameter (representing the number of players for a game) and returns a Map<String, List<Card>> that represents each player (i.e. "Player 1", "Player 2", etc..) and their cards.
		//
    ...
    if (52%numOfPlayers != 0) {
      System.out.println("With " + numOfPlayers + " player -- ");
      System.out.println("Cards left in deck " + 52%numOfPlayers);
    } else { 
      System.out.println("All cards have neen dealt");
    }
